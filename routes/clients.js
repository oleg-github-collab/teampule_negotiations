...
r.post('/', (req, res) => {
  try {
    ...
    const info = run(
      `
      INSERT INTO clients(
        company, negotiator, sector, company_size, negotiation_type, deal_value, 
        timeline, goal, decision_criteria, constraints, user_goals, client_goals, 
        competitors, competitive_advantage, market_position, weekly_hours, 
        offered_services, deadlines, previous_interactions, notes,
