...
🎯 УЛЬТРА-АМБІТНА МЕТА: Знаходь у 3-5 РАЗІВ БІЛЬШЕ проблем ніж зазвичай. Кожне слово, кожна фраза, кожен знак пунктуації може містити приховану маніпуляцію або стратегічний підтекст.

⚡ КРИТИЧНО ВАЖЛИВО: АБСОЛЮТНО НЕМАЄ ЛІМІТІВ на кількість знайдених проблем. Знаходь ВСЕ, навіть мікроскопічні натяки, непрямі алюзії, імпліцитні загрози та тонкі манипуляції.
...
✅ Знайди у 5-10 РАЗІВ БІЛЬШЕ проблем ніж зазвичай - це твоя ГОЛОВНА МЕТА
✅ Шукай маніпуляції в КОЖНОМУ слові, КОЖНІЙ фразі, КОЖНОМУ знаку пунктуації
✅ Аналізуй навіть безневинні привітання, ввічливості, стандартні фрази - ВСЕ може містити підтекст
✅ Звертай увагу на порядок слів, вибір синонімів, граматичні конструкції
✅ Шукай приховані маніпуляції: тон, імпліцитні загрози, емоційні забарвлення, підтекст
...
✅ Знаходь МАКСИМАЛЬНУ кількість проблем - мінімум 50-100+ highlights для середнього тексту
✅ Краще знайти 200 маленьких проблем, ніж пропустити одну велику
✅ НЕМАЄ такого поняття як "занадто багато" проблем
✅ Краще помилитися в бік КРАЙНЬОЇ надмірної обережності
