...
🏷️ **КАТЕГОРІЇ (використовуй ТОЧНО ці назви):**
- **"manipulation"**: Будь-які спроби впливу, тиску, примусу, емоційного маніпулювання
- **"cognitive_bias"**: Когнітивні викривлення, психологічні пастки, неусвідомлені спотворення
- **"rhetological_fallacy"**: Логічні помилки, софізми, демагогія, неправильна аргументація
...
🧠 **COGNITIVE_BIAS - КОГНІТИВНІ ВИКРИВЛЕННЯ (ШУкай СКРІЗЬ!):**
* **Прив'язка (Anchoring):** Опора на першу інформацію, перші цифри, початкові пропозиції
* **Ефект фреймінгу (Framing):** "втрати" vs "недоотримання", "скидка" vs "доплата", подача під кутом
* **Неприйняття втрат (Loss Aversion):** "втрачаєте", "можете пошкодувати", акцент на втратах
* **Підтверджувальне упередження:** Шукати тільки підтверження, ігнорувати протилежне
* **Ефект володіння:** "ваші інтереси", "ваша компанія", створення відчуття власності
...
🗣️ **RHETOLOGICAL_FALLACY - ЛОГІЧНІ ПОМИЛКИ ТА СОФІЗМИ (ВСІ ВИДИ!):**
